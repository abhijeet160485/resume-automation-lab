...
**Infrastructure & Cloud Operations Manager | Senior DevOps Engineer | SRE**

Greater Noida, Delhi/NCR • +91 9321191745 • abhijeet.k.srivastava@gmail.com • [linkedin.com/in/abhijeet-k-srivastava](https://linkedin.com/in/abhijeet-k-srivastava)

*Azure Certified • AWS Certified • ITIL V3 Foundation • Splunk • 15+ Years Experience*
...
| **Leadership** | Team Building • P&L Ownership • Vendor Mgmt • Stakeholder Communication • Hiring & Mentoring • OKRs |
| **Scripting** | Shell Scripting • Python (basic) • PL/SQL • Automation Frameworks |
| **AI & Copilot** | Microsoft 365 Copilot (Teams, ServiceNow) • Google Cloud Generative AI • Prompt Engineering (Vertex AI) • AI-assisted RCA & Incident Docs • SQL Query Engineering • Ansible Playbook Dev • Log Monitoring Automation • AIOps |
...
### Application Engineer | Polaris Financial Technologies (Client: Deutsche Bank)
**Mumbai • Aug 2013 – Feb 2015**

- Delivered L2/L3 application support for Deutsche Bank's critical banking platforms — managed error handling, hotfixes, release coordination, PL/SQL query optimisation, and database patching.

---

### Assistant Manager – IT Operations | Reliance Tech Services Pvt. Ltd
**Mumbai • Aug 2010 – Aug 2013**

- Managed WebSphere deployments, shell script automation, database health checks, and 24/7 operational support for ICCM and View Bill applications with strict SLA adherence.
...
- Google Cloud: Generative AI Fundamentals (Mar 2026)
